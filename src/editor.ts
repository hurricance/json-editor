// DOM elements
const leftEditor = document.getElementById('left-editor') as HTMLTextAreaElement;
const rightEditor = document.getElementById('right-editor') as HTMLTextAreaElement;
...
function collectJsonStringPaths(
  obj: unknown,
  path: string[] = [],
): string[][] {
  const out: string[][] = [];
...
function updateLineNumbers(ta: HTMLTextAreaElement, gutter: HTMLElement): void {
...
function bindLineNumbers(ta: HTMLTextAreaElement, gutter: HTMLElement): void {
